                  ...
                  itemBuilder: (BuildContext context, int index) {
                     ...
                     var imageurl =  wppost["_embedded"]["wp:featuredmedia"][0]["source_url"];
                      Padding(
                        ...
                        child: Column(
                           children: [
                             Text(wppost['title']['rendered'] .replaceAll('&#8216;', '\'')
                            .replaceAll('&#8217;', '\'')
                            .replaceAll('&#8212;', '-')
                            .replaceAll('&#038;', '&'), style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.blueAccent),),
                      ...
                      onTap: () {
                        ...
                        Navigator.of(
                            context, rootNavigator: true).pushNamed( '/Article',
                            arguments: {
                              'title': wppost['title']['rendered'] .replaceAll('&#8216;', '\'')
                            .replaceAll('&#8217;', '\'')
                            .replaceAll('&#8212;', '-')
                            .replaceAll('&#038;', '&').toString(),
                              'content': snapshot.data[index]['content']['rendered'].toString(),
                            });
                      },
